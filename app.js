class FinanceTracker {
    ...
    init() {
        ...
        if (transactionForm) {
            transactionForm.addEventListener('submit', this.handleAddTransaction);
        }
        if (goalForm) {
            goalForm.addEventListener('submit', this.handleAddGoal);
        }
    ...
    calculateTotals() {
        ...
        // Add this line to update the display after calculations
        this.updateSummary();
    }
    ...
    updateSummary() {
        ...
        const expensesEl = document.getElementById('expense');
        ...
        if (balanceEl) balanceEl.textContent = this.formatCurrency(this.balance);
        if (incomeEl) incomeEl.textContent = this.formatCurrency(this.income);
        if (expensesEl) expensesEl.textContent = this.formatCurrency(this.expenses);
    }
